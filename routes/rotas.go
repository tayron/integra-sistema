...
func CarregarRotas() {
	...
	r.HandleFunc("/integracao/cadastrar", controllers.CadastrarIntegracao).Methods("POST")
	r.HandleFunc("/integracao/editar/{id:[0-9]+}", controllers.EditarIntegracao).Methods("GET")
	r.HandleFunc("/integracao/editar/{id:[0-9]+}", controllers.EditarIntegracao).Methods("POST")
	...
	r.HandleFunc("/parametros/integracao/{id:[0-9]+}", controllers.ListarParametro).Methods("POST")
